...
const TrabalheConosco = () => {
  useEffect(() => {
    ...
    window.open("https://fppopular.vagas.solides.com.br/#banco-de-talentos", "_blank");
  }, []);

  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center bg-background px-4">
      <h1 className="text-3xl md:text-4xl font-bold text-primary mb-4">
        Portal de Vagas Aberto em Nova Aba
      </h1>
      <p className="text-muted-foreground mb-8 max-w-md">
        Caso não tenha sido redirecionado,{" "}
        <a
          href="https://fppopular.vagas.solides.com.br/#banco-de-talentos"
          target="_blank"
